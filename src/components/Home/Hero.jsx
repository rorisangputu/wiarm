  ...
  return (
    <div className="relative w-full h-screen md:h-[55vh] flex items-center justify-center bg-gray-900 text-white">
      ...
      <div className="top-4 relative z-10 text-center px-6">
        <h1 className="text-4xl font-semibold md:text-6xl">Agriculture for Liberation</h1>
        ...
        <HeroButton styles={"font-sans mt-6 px-12 md:px-16 py-3 md:py-5 md:text-xl bg-green-800 hover:bg-green-900 text-white font-medium rounded-xl transition duration-300"}/>
      </div>
    </div>
