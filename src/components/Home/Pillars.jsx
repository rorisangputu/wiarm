        ...
        <div className='flex flex-col'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-5 md:py-7'>
            <div className='flex flex-col gap-1 md:text-center'>
              <h1 className='font-normal text-green-800 text-md md:text-lg'>Reclaiming Land</h1>
            ...
            <div className='flex flex-col gap-1 md:text-center'>
              <h1 className='font-normal text-green-800 text-md md:text-lg'>Food Sovereignty</h1>
              <p className='text-md font-light text-slate-900'>
            ...
            <div className='flex flex-col gap-1 md:text-center'>
              <h1 className='font-normal text-green-800 text-md md:text-lg'>Education & Advocacy</h1>
              <p className='text-md font-light text-slate-900'>
