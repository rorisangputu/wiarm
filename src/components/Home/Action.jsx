        ...
        <div className='w-[90%] mx-auto py-10 relative z-10'>
            <div className='flex flex-col items-center gap-5'>
                <div className='flex flex-row items-center gap-5'>
                    ...
                    <h1 className='font-sans text-md text-green-900 font-medium tracking-[0.2em] uppercase'>Join Us!</h1>
                    <hr className='w-12 border-slate-300'/>
                </div>
                <div className='flex flex-col text-center gap-5'>
                    <h2 className='text-4xl font-medium text-gray-600 leading-10 tracking-tight capitalize'>Become a part of this life-changing journey.</h2>
